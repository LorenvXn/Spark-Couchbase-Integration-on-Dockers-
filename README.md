...
But first thing first, we gon' do some replication: 
[Couchbase replication to Elasticsearch, and Spark](https://github.com/Satanette/Couchbase-replication-to-ElasticSearch-and-Spark)
